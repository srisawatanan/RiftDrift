 ...
 * This file demonstrates how to integrate Riftdrift with a web frontend
 */

// For React/Vue/Angular applications
export class RiftdriftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new RiftdriftClient(provider, contractAddress);
